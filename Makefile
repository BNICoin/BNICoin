#############################################################################
# Makefile for building: BNI-qt
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  BNI-qt.pro
# Template: app
# Command: C:\Qt\5.3.2\bin\qmake.exe RELEASE=1 USE_UPNP=- USE_QRCODE=1 -o Makefile BNI-qt.pro
#############################################################################
...
Makefile: BNI-qt.pro ../Qt/5.3.2/mkspecs/win32-g++/qmake.conf ../Qt/5.3.2/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) RELEASE=1 USE_UPNP=- USE_QRCODE=1 -o Makefile BNI-qt.pro
...
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\bni-master\bni-qt_plugin_import.cpp

C:/bni-master/src/leveldb/libleveldb.a: FORCE
