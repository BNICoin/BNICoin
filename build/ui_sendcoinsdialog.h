...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 BNI"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 BNI"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 BNI"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 BNI"));
        ...
        labelBalance->setText(QStringLiteral("123.456 BNI"));
