...
static const unsigned int MAX_BLOCK_SIZE = 3250000;
...
static const int64_t MAX_MONEY = 300000000 * COIN; // 300 Million
inline bool MoneyRange(int64_t nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp. */
static const unsigned int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
/** PoS Staking reward */
static const int64_t COIN_YEAR_REWARD1 = 8 * CENT; // 8% per year
/** Protocol toggle */
inline bool IsProtocolV2(int nHeight) { return TestNet() || nHeight > 0; }
inline bool IsProtocolV3(int64_t nTime) { return TestNet() || nTime > 1492387200; } // Mon, 17 Apr 2017 00:00:00 GMT
/** Future drift params */
inline int64_t FutureDriftV1(int64_t nTime) { return nTime + 10 * 60; }
inline int64_t FutureDriftV2(int64_t nTime) { return nTime + 25 * 60; }
inline int64_t FutureDrift(int64_t nTime, int nHeight) { return IsProtocolV2(nHeight) ? FutureDriftV2(nTime) : FutureDriftV1(nTime); }
/** Desired block times/spacing */
inline unsigned int GetTargetSpacing(int nHeight) { return IsProtocolV2(nHeight) ? 120 : 60; }
