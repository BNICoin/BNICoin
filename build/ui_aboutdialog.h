...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About BNI", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>BNI</b> version", 0));
...
"Copyright \302\251 2014 The BNI developers", 0));
